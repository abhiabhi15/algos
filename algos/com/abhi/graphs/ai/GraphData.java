...
public class GraphData {
    ...
    private void initRomania() {

        Map<String,Node> nodes = new LinkedHashMap<String, Node>();
        List<City> cities = getCityPositions("Romania");
        ...
        List<CityMap> cityMapList = getCityMap("Romania");
    ...
    private void initUSA() {
        ...
        Map<String,Node> nodes = new LinkedHashMap<String, Node>();
        List<City> cities = getCityPositions("USA");
        for(City city : cities){
        ...
        List<CityMap> cityMapList = getCityMap("USA");
        for(CityMap cityMap : cityMapList){
    ...
    private List<City> getCityPositions(String country) {

        List<City> cities = new LinkedList<City>();
        String cityPositionStr = cityPositionData(country);
    ...
    private List<CityMap> getCityMap(String country){

        List<CityMap> cityMaps = new LinkedList<CityMap>();
        String cityMapStr = cityMapData(country);
